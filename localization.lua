...
CENSUSPlus_BUTTON_TEXT      = "Census+ Turtle";
CENSUSPlus_BUTTON_SUBTEXT   = "Realm Census";
CENSUSPlus_BUTTON_TIP       = "Click here to show or hide Census+ Turtle.";
CENSUSPlus_HELP             = " Use /censusplus to open and close the Census+ Turtle UI.";
...
CENSUSPlus_UPLOAD           = "You can view some CensusPlus Turtle data here: https://turtle-census.org/";
...
CENSUSPlus_STOPCENSUS       = "Stop the currently active Census";
...
CENSUSPlus_ISINPROGRESS     = "A Census is in progress, try again later";
...
CENSUSPlus_OPTIONS_HEADER	= "Census+ Turtle Options";
...
CENSUSPlus_AUTOSTART_TOOLTIP = "Enable Census+ Turtle to start automatically";
CENSUSPlus_VERBOSE_TOOLTIP  = "Deselect to stop the spam!";
CENSUSPlus_AUTOCENSUS_TOOLTIP = "Enable Census+ Turtle to run automatically while playing";
...
CENSUS_BUTTON_TOOLTIP		= "Open CensusPlus Turtle";
