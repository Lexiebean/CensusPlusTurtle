...
function CensusPlus_UpdateView()
	...
	for i = 1, numRaces, 1 do
		...
		local normalTextureName="Interface\\AddOns\\CensusPlusTurtle\\Skin\\CensusPlus_"..g_RaceClassList[race];
	...
	for i = 1, numClasses, 1 do
		...
		local normalTextureName="Interface\\AddOns\\CensusPlusTurtle\\Skin\\CensusPlus_"..g_RaceClassList[class];
...
function CensusPlus_UpdateGuildButtons()
	...
	while (i <= CensusPlus_NUMGUILDBUTTONS) do
		...
		if (iGuild <= size) then
			...
			textField = "CensusPlusGuildButton"..i.."Count";
			getglobal(textField):SetText("["..guild.m_Count.."]");
